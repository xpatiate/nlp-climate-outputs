...
An initial pass at applying the questions in the [Climate Emergency Attributes framework](https://doi.org/10.1016/j.uclim.2020.100666) to a local government climate policy. 

Using GPT model 3.5, accessed via langchain using the map-reduce chain, with 4000-character chunks of context and customised question and combine prompts. See https://python.langchain.com/docs/modules/chains/additional/question_answering.html

The climate policy is [A Framework for Climate Action](https://www.armidaleregional.nsw.gov.au/ArticleDocuments/1136/AI%202021%2002335%20%20CEWG%20Report%20-%2026oct2020-V5-1.pdf.aspx), April 2020.
